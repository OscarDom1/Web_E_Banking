        ...
        <div class="container">
            <div class="profile">
                ...
                <div class="profile-info">
                    <p class="welcome-message">Hi, {{ $user->name }}</p><br>
                    <p class="profile-details"><span>Full name:</span> {{ $user->name }}</p><br>
                    <p class="profile-details"><span>Email:</span> {{ $user->email }}</p><br>
                    <p class="profile-details"><span>Phone Number:</span> {{ $user->phone_number }}</p><br>
                    <p class="profile-details"><span>Address:</span> {{ $user->address }}</p><br>
                    <p class="profile-details"><span>State of Origin:</span> {{ $user->state_of_origin }}</p><br>
                </div>
                <a class="update-profile-link" href="/features/edit-profile">Update Profile</a>
            </div>
        </div>
