        ...
        <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6">
              <div
                class="single-getting-started-card"
                data-aos="fade-up"
                data-aos-delay="50"
                data-aos-duration="500"
                data-aos-once="true"
              >
                <div class="getting-image">
                  <img
                    src="{{ asset('images/getting-started/getting-1.png') }}"
                    alt="image"
                  />
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              ...
              >
                <div class="getting-image">
                  <img
                    src="{{ asset('images/getting-started/getting-2.png') }}"
                    alt="image"
                  />
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              ...
              >
                <div class="getting-image">
                  <img
                    src="{{ asset('images/getting-started/getting-3.png') }}"
                    alt="image"
                  />
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              ...
              >
                <div class="getting-image">
                  <img
                    src="{{ asset('images/getting-started/getting-4.png') }}"
                    alt="image"
                  />
                </div>
            ...
            <div class="col-lg-6 col-md-12">
              ...
              >
                ...
                <p>
                  ...
                  congue id tempus fringilla diam arcu. Venenatis nulla senectus
                  risus sagittis turpis felis egestas.
                </p>
              ...
              <div class="why-choose-us-image">
                <div class="row align-items-center">
                  <div class="col-lg-6 col-sm-6">
                    ...
                    >
                      <img
                        src="{{ asset('images/why-choose-us/choose-1.jpg') }}"
                        alt="image"
                      />
                    </div>
                  </div>
                  <div class="col-lg-6 col-sm-6">
                    ...
                    >
                      <img
                        src="{{ asset('images/why-choose-us/choose-2.jpg') }}"
                        alt="image"
                      />
                    </div>
                    <div
                    ...
                    >
                      <img
                        src="{{ asset('images/why-choose-us/choose-3.jpg') }}"
                        alt="image"
                      />
                    </div>
                  </div>
                ...
                <div class="choose-shape" data-speed="0.08" data.-revert="true">
                  <img
                    src="{{ asset('images/why-choose-us/shape-1.png') }}"
                    alt="image"
                  />
                </div>
                <div class="choose-shape-2" data-speed="0.08" data-revert="true">
                  <img
                    src="{{ asset('images/why-choose-us/shape-2.png') }}"
                    alt="image"
                  />
                </div>
              </div>
