...
<style>
    ...
    .set-pin-page input[type="password"] {
        width: 100%;
        padding: 10px;
        margin-bottom: 10px;
        border: 1px solid #ccc;
    ...
    .set-pin-page button[type="submit"] {
        padding: 10px 20px;
...
<body class="crm_body_bg">
    ...
    <section class="main_content dashboard_part">
                            ...
                            <div class="profile_info">
                                ...
                                <div class="profile_info_iner">
                                    ...
                                    <div class="profile_info_details">
                                        ...
                                        <a href="#">Change Pin <i class="ti-settings"></i></a>
        ...
        <div class="set-pin-page">
            <h5 class="text-center">Set Transfer PIN</h5>
            <form action="{{ route('customer.set-pin') }}" method="POST">
                @csrf
                ...
                <input type="password" name="confirm_pin" placeholder="Confirm your PIN">
