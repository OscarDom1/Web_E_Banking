                ...
                @foreach (Auth::user()->unreadNotifications as $notification)
                    @if ($notification->type === 'App\Notifications\NewUserRegisteredNotification')
                        <li class="notification-item">
                            <strong class="text-bold">New Registered User</strong><br><br>
                            <strong>Full Name:</strong> {{ $notification->data['user_name'] }}<br>
                            <strong>Email Address:</strong> {{ $notification->data['user_email'] }}<br>
                            <span class="notification-info">Registered on:
                                {{ $notification->created_at->format('Y-m-d H:i:s') }}</span>
                        </li>
                    @endif
                @endforeach
            </ul>
