...
<style>
    ...
    .create-message-form input[type="text"],
    ...
    .create-message-form button[type="submit"] {
...
<body class="crm_body_bg">
    ...
    <section class="main_content dashboard_part">
        ...
        <div class="create-message-form">
            <h5 class="text-center">Create Message</h5>
            <form action="{{ route('admin.send-message.store') }}" method="POST">
                @csrf

                <label for="recipient_id">Recipient ID:</label>
                <input type="text" name="recipient_id" placeholder="Recipient ID">
